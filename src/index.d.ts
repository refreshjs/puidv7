 ...
 */
export declare function validatePrefix(prefix: string): void;
/**
 ...
 */
export declare function encodeId(uuid: string, prefix: string): string;
/**
 * validateId validates a lowercased, url-safe, prefixed crockford base32 ID,
 * including checking the prefix is valid
 */
export declare function validateId(id: string, prefix: string): void;
/**
 ...
 */
export declare function decodeId(id: string, prefix: string): string;
/**
